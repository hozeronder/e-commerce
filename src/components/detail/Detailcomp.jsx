...
const Detailcomp = ({productDetail}) => {
    ...
    return (<div className='flex gap-10 my-10'>
        ...
        <div className="">
            ...
            <div onClick={addBasket}
                 className="py-4 border w-[200px] text-2xl rounded-md bg-gray-200 cursor-pointer h-16 flex items-center justify-center">Add
                Basket
            </div>
        </div>
    </div>)
